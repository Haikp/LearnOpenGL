...
int main(void)
{
    ...
    float points[] = {
        -0.7f,  0.5f,  0.0f,  // Point 1
        0.2f, -0.3f,  0.0f,  // Point 2
        -0.5f, -0.8f,  0.0f,  // Point 3
        0.8f,  0.6f,  0.0f,  // Point 4
        0.0f,  0.0f,  0.0f,  // Point 5 (center)
        -0.9f,  0.2f,  0.0f,  // Point 6
        0.5f, -0.7f,  0.0f,  // Point 7
        0.4f,  0.8f,  0.0f,  // Point 8
    };
