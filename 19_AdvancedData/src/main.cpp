...
int main(void)
{
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(cubePositions) + sizeof(cubeNormals), nullptr, GL_STATIC_DRAW);
    ...
    glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, 3 * sizeof(float), (void*)(sizeof(cubeNormals)));
